...
public class ZipUtils {
    public static byte[] zipFile(String name, byte[] content) {
    ...
    private static void addZipEntry(ZipOutputStream zos, Path file, String realName) throws IOException {
        addZipEntry(zos, realName, Files.readAllBytes(file));
    }

    public static void addZipEntry(ZipOutputStream zos, String realName, byte[] bytes) throws IOException {
