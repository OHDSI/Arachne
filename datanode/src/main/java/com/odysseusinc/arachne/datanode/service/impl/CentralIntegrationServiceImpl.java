...
@Slf4j
@Service
public class CentralIntegrationServiceImpl implements CentralIntegrationService {
    @Autowired
    ...
    @Override
    public CommonDataSourceDTO sendDataSourceCreationRequest(User user, DataNode dataNode, CommonDataSourceDTO commonCreateDataSourceDTO) {
        JsonResult<CommonDataSourceDTO> jsonResult = centralClient.createDataSource(dataNode.getCentralId(), commonCreateDataSourceDTO);
        validatePersistDataSourceResult(jsonResult, CANNOT_CREATE_DATASOURCE);
        return jsonResult.getResult();
    }

    @Override
    public CommonDataSourceDTO sendDataSourceUpdateRequest(User user, Long centralDataSourceId, CommonDataSourceDTO commonCreateDataSourceDTO) {
        JsonResult<CommonDataSourceDTO> jsonResult = centralClient.updateDataSource(centralDataSourceId, commonCreateDataSourceDTO);
        validatePersistDataSourceResult(jsonResult, CANNOT_UPDATE_DATASOURCE);
        return jsonResult.getResult();
    }

    private void validatePersistDataSourceResult(JsonResult<CommonDataSourceDTO> jsonResult, String errorMessageTemplate) {
    ...
    @Override
    public JsonResult<CommonDataSourceDTO> getDataSource(User user, Long id) {
