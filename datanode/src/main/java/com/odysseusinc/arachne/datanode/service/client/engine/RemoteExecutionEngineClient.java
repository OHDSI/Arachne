...
@Component
@Slf4j
public class RemoteExecutionEngineClient implements ExecutionEngineClient {
    ...
    public RemoteExecutionEngineClient(
    ...
    public CompletableFuture<AnalysisRequestStatusDTO> sendAnalysisRequest(
        ...
        Call call = httpClient.newCall(request);
        FailsafeCall failsafeCall = FailsafeCall.with(retryPolicy()).compose(call);
        AnalysisRequestStatusDTO result = executeRequest(url, failsafeCall, AnalysisRequestStatusDTO.class);
