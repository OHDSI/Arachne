...
public interface StudyPackageRepository extends JpaRepository<StudyPackage, Long> {
    ...
    List<StudyPackage> findAllByOrderByInstalledAtDesc();

    List<StudyPackage> findByNameOrderByInstalledAtDesc(String name);

    Optional<StudyPackage> findByNameAndVersion(String name, String version);
