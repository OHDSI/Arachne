...
public class CheckDataSourceCallbackController {
    ...
    @PostMapping(value = Api.CHECK_STATUS, consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public void status(
    ...
    @Async
    @PostMapping(value = Api.CHECK_RESULT, consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
