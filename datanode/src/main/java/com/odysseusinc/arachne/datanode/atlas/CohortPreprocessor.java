...
public class CohortPreprocessor implements Preprocessor<Analysis> {
    ...
    public void preprocess(Analysis analysis, File file) {
        ...
        if (!cohortService.isPreprocessingIgnored(file) && (CommonCohortDTO.COHORT == analysis.getType() || executableFile)) {
            ...
            final SqlUtils.TranslateOptions options = new SqlUtils.TranslateOptions(
            ...
            try {
                ...
                final String nativeStatement
                        = SqlUtils.translateSQL(sourceStatement, null, target, sessionId, resultDbSchema, options);
                ...
                satellites.forEach((key, resource) -> {
                    try {
                        ...
                        final String satelliteNativeStatement
                                = SqlUtils.translateSQL(satelliteSourceStatement, null, target, sessionId, resultDbSchema,  options);
