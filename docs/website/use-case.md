...
**As a researcher running studies**, I want to use a **Study Repository** so that I can:
...
I can open **Settings** and type in the address of the study catalog (e.g. a Docker registry). That’s the only place I need to configure the “repo.”

### See what’s on my machine

I open **Study Repository** and see a list of study packages that are already downloaded on this machine. Each one is linked to that catalog and I can tell at a glance what I have.
...
I can click **View results**. The app starts an interactive results viewer (e.g. a Shiny app) for that study and gives me a link. I can open it in a new browser tab and explore results there. The link is shown in the UI so I can copy it or open it again.
