...
class HeraclesHeel extends CommonObjectJson {
    ...
    public HeraclesHeel(@JsonProperty(value = "heraclesHeel", required = true) HeraclesHeelInner[] heraclesHeel) {

        this.heraclesHeel = heraclesHeel;
    }

    static class HeraclesHeelInner {
        public long ATTRIBUTE_NAME;
