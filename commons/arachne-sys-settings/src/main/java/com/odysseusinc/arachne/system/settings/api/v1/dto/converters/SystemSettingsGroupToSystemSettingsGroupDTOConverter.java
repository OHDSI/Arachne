...
@Component
public class SystemSettingsGroupToSystemSettingsGroupDTOConverter
        implements Converter<SystemSettingsGroup, SystemSettingsGroupDTO>, InitializingBean {
    ...
    @Override
    public SystemSettingsGroupDTO convert(SystemSettingsGroup systemSettingsGroup) {

        SystemSettingsGroupDTO dto = new SystemSettingsGroupDTO();
        dto.setId(systemSettingsGroup.getId());
        dto.setLabel(systemSettingsGroup.getLabel());
        dto.setName(systemSettingsGroup.getName());
        LinkedList<SystemSettingDTO> dtos = new LinkedList<>();
        for (SystemSetting systemSetting : systemSettingsGroup.getSettings()) {
            dtos.add(conversionService.convert(systemSetting, SystemSettingDTO.class));
        }
